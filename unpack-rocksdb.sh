...
# This list is based on CXX_OBJECTS from the Makefile. It must be generated when
# the rocksb version changes.
#
tar -xzf "$ROCKSDB_ARCHIVE" \
    ${ROCKSDB_BASE}/include \
    ${ROCKSDB_BASE}/cache/cache.cc \
    ${ROCKSDB_BASE}/cache/cache_entry_roles.cc \
    ${ROCKSDB_BASE}/cache/cache_key.{cc,h} \
    ...
    ${ROCKSDB_BASE}/db/periodic_work_scheduler.cc \
    ...
    ${ROCKSDB_BASE}/port/port.h \
    ${ROCKSDB_BASE}/port/lang.h \
    ...
    ${ROCKSDB_BASE}/table/block_based/block_based_filter_block.cc \
    ...
    ${ROCKSDB_BASE}/utilities/backupable/backupable_db.cc \
    ...
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/locktree/concurrent_tree.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/locktree/keyrange.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/locktree/lock_request.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/locktree/locktree.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/locktree/manager.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/locktree/range_buffer.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/locktree/treenode.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/locktree/txnid_set.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/locktree/wfg.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/standalone_port.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/util/dbt.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/lib/util/memarena.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/range_tree_lock_manager.cc \
    ${ROCKSDB_BASE}/utilities/transactions/lock/range/range_tree/range_tree_lock_tracker.cc

# It's tedious to extract only relevant headers. Instead we just take them all, even
# if it's more data.
#
tar -xzf "$ROCKSDB_ARCHIVE" '*.h'
